...
describe('Master Test Suite', function () {
  before(function () {
    (0, _addContext.addContext)(this, 'this context is before all tests');
  });

  after(function () {
    (0, _addContext.addContext)(this, 'this context is after all tests');
  });

  describe('Test Suite with Context', function () {
    ...
    it('should have url context, with protocol', function (done) {
      (1 + 1).should.equal(2);
      (0, _addContext.addContext)(this, 'http://www.apple.com');
      done();
    });
    it('should have url context, ftp', function (done) {
      (1 + 1).should.equal(2);
      (0, _addContext.addContext)(this, 'ftp://www.apple.com');
      done();
    });
    ...
    it('should have text context - image', function (done) {
      (0, _addContext.addContext)(this, 'http://shushi168.com/data/out/193/37127382-random-image.png');
      (1 + 1).should.equal(2);
      done();
    });
    it('should not have context', function () {
      (0, _addContext.addContext)(undefined, 'http://shushi168.com/data/out/193/37127382-random-image.png');
      (1 + 1).should.equal(2);
    });
  });

  describe('beforeEach Context', function () {
    beforeEach(function () {
      (0, _addContext.addContext)(this, 'this is the beforeEach context');
    });
  ...
  describe('afterEach Context', function () {
    beforeEach(function () {
      (0, _addContext.addContext)(this, 'this is the afterEach context');
    });
