...
var _utils$utilsjs = utils.utilsjs,
    log = _utils$utilsjs.log,
    cleanCode = _utils$utilsjs.cleanCode,
    cleanTest = _utils$utilsjs.cleanTest,
    cleanSuite = _utils$utilsjs.cleanSuite;
